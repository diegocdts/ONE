...
import report.MovementNs2Report;
...
public class DTNHost implements Comparable<DTNHost>, Iterable<Connection> {
	...
	public double nextTimeToRecordMobility = 0.0;
	...
	private boolean setNextWaypoint() {
		...
		if (this.movListeners != null) {
			for (MovementListener l : this.movListeners) {
				if (!(l instanceof MovementNs2Report)) {
	...
	public void recordMobility() {
		if (SimClock.getTime() >= this.nextTimeToRecordMobility) {
			if (this.movListeners != null) {
				for (MovementListener l : this.movListeners) {
					if (l instanceof MovementNs2Report) {
						l.newDestination(this, this.destination, this.speed);
			...
			this.nextTimeToRecordMobility += 10;
		}
	}
}
